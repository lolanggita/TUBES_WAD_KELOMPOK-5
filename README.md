...
| 3. Registrasi dari Postingan | EventRegistrationController, EventRegistration model, migration | Anggota 2                | Pengguna dapat mendaftar ke event jika `is_registrable == true`. Buat form + validasi API untuk registrasi                         |
...
| 5. Profil UKM                | UKMController, UKM model, migration ukms                        | Anggota 3                | CRUD profil UKM (nama, deskripsi, logo, kontak). Dapat disesuaikan oleh masing-masing UKM                                          |
| 6. Galeri Dokumentasi UKM    | GalleryController, Gallery model, migration galleries           | Anggota 5                | Upload dan list gambar kegiatan. Hanya bisa dilakukan oleh akun UKM yang terkait                                                   |
